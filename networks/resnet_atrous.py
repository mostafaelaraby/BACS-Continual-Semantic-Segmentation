# adapted from https://github.com/LTTM/SDR
import torch.nn as nn
import torch.utils.model_zoo as model_zoo
from .utils import SynchronizedBatchNorm2d
import os
import torch
...
_NETS = {
    "resnet50": {"structure": [3, 4, 6, 3], "atrous": [1, 2, 1]},
    "resnet101": {"structure": [3, 4, 23, 3], "atrous": [2, 2, 2]},
    "resnet152": {"structure": [3, 8, 36, 3], "atrous": [2, 2, 2]},
}
...
def create_resnet_atrous(arch, output_stride=16, pretrained=False, **kwargs):
